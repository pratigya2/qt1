#include "admin_series.h"
#include "ui_admin_series.h"
...
admin_series::admin_series(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::admin_series)
{
    ui->setupUi(this);
    setWindowTitle("CC");
...
void admin_series::on_pushButton_6_clicked()
{
