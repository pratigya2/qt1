...
#include "ui_admin_series_adding.h"
...
admin_series_adding::admin_series_adding(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::admin_series_adding)
{
    ui->setupUi(this);
...
admin_series_adding::~admin_series_adding()
{
    delete ui;
}
void admin_series_adding::on_pushButton_6_clicked()
{
        ...
        QString filename = QFileDialog::getOpenFileName(this, tr("choose"), "", tr("Images(*.png *.jpg *.jpeg *.bmp *.gif"));
            ...
            QString dbName("C:/Users/user/Documents/New folder/qtcode/series.db");
            ...
            query.prepare("insert into series values(:Name,:Summary,:Date,:Director,:Cast_members,:Ratings,:Image,:Genre,:Language,:Trailer_link)");
